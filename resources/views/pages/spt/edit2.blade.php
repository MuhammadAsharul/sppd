                            ...
                            <div class="row">
                                <div class="col-md-6 grid-margin">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="time" value="{{ $spt->waktu }}" class="form-control" id="waktu" name="waktu"
                                ...
                                <div class="col-md-6 grid-margin">
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $spt->hari_tgl }}" type="date" class="form-control" id="hari_tgl" name="tgl_pergi"
                                            placeholder="Pilih Hari Tanggal">
                                    </div>
                                    <div class="form-group">
                                        <label for="tempat">Tempat</label>
                                        <input type="text" class="form-control" id="tempat" name="tempat" value="{{ $spt->tempat }}"
                                            placeholder="Pilih Tempat">
                                    </div>
                                    <div class="form-group">
                                        <label for="tempat_ditetapkan">Tempat Ditetapkan</label>
                                        <input type="text" class="form-control" id="tempat_ditetapkan" name="tempat_ditetapkan" value="{{ $spt->tempat_ditetapkan }}">
                                    </div>
                                    <div class="form-group">
                                        <label for="tgl_ditetapkan">Tanggal Ditetapkan</label>
                                        <input value="{{ $spt->tgl_ditetapkan }}" type="date" class="form-control" id="tgl_ditetapkan" name="tgl_ditetapkan"
